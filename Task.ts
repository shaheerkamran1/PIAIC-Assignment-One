...
1. **Scenario:**
   ...
   2. **Requirements:**
    ...
    - **Scenario 3 - Checkout Process:**
        ...
        let apple:number=10;
        let mango:number=8;
        let banana:number=12;

        let fruits=[apple,mango,banana];

        let tomato:number=7;
        let potato:number=11;
        let pumpkin:number=15;
        ...
        let choice:number=userInput.choice as number;
        ...
        let choiceCatagory:number=userInputCatagory.choiceCat;
        ...
        let quantity:number = userInputQuantity.choiceQuantity;

        let billapple:number=quantity*fruits[apple]
        let billmango:number=quantity*fruits[mango]
        let billbanana:number=quantity*fruits[banana]

        let billFruits:number=billapple+billmango+billbanana

        let billtomato:number=quantity*vegetables[tomato]
        let billpotato:number=quantity*vegetables[potato]
        let billpumpkin:number=quantity*vegetables[pumpkin]

        let billVegetables:number=billtomato+billpotato+billpumpkin

        let totBill:number=billFruits+billVegetables
        ...
        function discount(totBill:number):number{
           
            let disc:number=totBill-(totBill*10/100)
            if(totBill>=300)
            {
                return disc
            }
...
console.log(`Your discount is ${discount(totBill)}`)
